...
function setQuizEnv() { 
    ...
    quizhtml1 += '<img class="topt" src="' + window.url_true + '"/>';
    quizhtml1 += '<img class="fopt" src="' + window.url_false + '" />';
    quizhtml1 += '</div>';          
    
    quizhtml2 = '<div class="text" style="background-color:#869fbb;">';
    quizhtml2 += '</div>';
    quizhtml2 += '<div class="answer" style="background-color:#869fbb;">';
    quizhtml2 += '<img class="topt" src="' + window.url_true + '"/>';
    quizhtml2 += '<img class="fopt" src="' + window.url_false + '" />';
    quizhtml2 += '</div>';          
    ...
    if (bTerminated == false) {
        ...
        for (i = curIndex - 2; i < curIndex + 3; i++, j++) {
            ...
            id = "#quiz0" + (j+1) + " .topt";
            $(id).attr('src', window.url_true);

            id = "#quiz0" + (j+1) + " .fopt";
            $(id).attr('src', window.url_false);
            
            if (alreadyAnswered(i) == true) {
                if (total_answers[i] == 1) {
                    id = "#quiz0" + (j+1) + " .topt";               
                    $(id).attr('src', window.url_true_sel);
                    id = "#quiz0" + (j+1) + " .fopt";               
                    $(id).attr('src', window.url_false);
                }
                    ...
                    $(id).attr('src', window.url_true);
                    id = "#quiz0" + (j+1) + " .fopt";               
                    $(id).attr('src', window.url_false_sel);
                }
...
$(document).ready(function() {
    ...
    var img1 = new Image();
    var img2 = new Image();
    img1.src = window.url_true_sel; //"img/true_selected.png";
    img2.src = window.url_false_sel; //"img/false_selected.png";
    ...
    $('#backbut, #backbut1').click(function(){
        window.location = window.back_url; //"student.html";
    });
    ...
    $('#scrollup').mousedown(function(){
        ...
        $(this).css('background-image','url("' + window.url_scrollupsel + '")');
    });
    $('#scrollup').mouseup(function(){
        //$(this).css('background-image','url("img/scrollUp.png")');
        $(this).css('background-image','url("' + window.url_scrollup + '")');
    });
    ...
    $('#scrolldown').mousedown(function(){
        ...
        $(this).css('background-image','url("' + window.url_scrolldsel + '")');
    });
    $('#scrolldown').mouseup(function(){
        //$(this).css('background-image','url("img/scrollDown.png")');
        $(this).css('background-image','url("' + window.url_scrolld + '")');
    });
