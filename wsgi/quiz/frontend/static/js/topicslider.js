...
function createPages(content_id, reduced, base_url) {
    var topics = [
    ...
    var quiz_url = base_url;//"Quiz.html";
    ...
    var fmt_chapter ='<tr><td width="30%" style="text-align:right">Capitolo {0}</td><td><a href="{2}/{3}">{1}</a></td></tr>';
    var fmt_topic ='<tr><td></td><td><a href="{1}/{2}">{0}</a></td></tr>';
...
function TopicSlider(element, reduced, base_url) {
    createPages(element + " #content", reduced, base_url);
