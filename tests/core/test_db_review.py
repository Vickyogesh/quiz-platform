...
class DbReviewTest(unittest.TestCase):
    ...
    def test_get(self):
        ...
        questions = self.db.getErrorReview(1, 'it')
    ...
    def test_saveWrong(self):
        # Wrong user
        self.db.saveErrorReview(100, [1], [1])

        # Empty questions
        try:
            self.db.saveErrorReview(1, [], [1])
        ...
        # Wrong questions
        try:
            self.db.saveErrorReview(1, ['b', 1], [1, 1])
        except QuizCoreError as e:
            err = e.message
        ...
        # Wrong answers
        try:
            self.db.saveErrorReview(1, [1, 1], ['b', 1])
        except QuizCoreError as e:
            err = e.message
        self.assertEqual('Invalid value.', err)
    ...
    # Check: normal save
    def test_save(self):
        self.db.saveErrorReview(100, [1, 2, 3, 4, 5], [1, 1, 0, 0, 0])
